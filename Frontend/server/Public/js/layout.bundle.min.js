...
!(function (t, e) {
  ...
  class Ht extends B {
    ...
    _addTouchEventListeners() {
      const t = (t) => {
        ...
        i = (t) => {
          !this._pointerEvent ||
            (t.pointerType !== $t && t.pointerType !== Mt) ||
      ...
      J.find(Nt, this._element).forEach((t) => {
        ...
        this._pointerEvent
          ? (j.on(this._element, bt, (e) => t(e)),
            j.on(this._element, vt, (t) => i(t)),
            this._element.classList.add(Lt))
          : (j.on(this._element, gt, (e) => t(e)),
            j.on(this._element, mt, (t) => e(t)),
            j.on(this._element, _t, (t) => i(t)));
    }
    _keydown(t) {
  ...
  class se extends B {
    ...
    _getDimension() {
      return this._element.classList.contains(Jt) ? te : ee;
    }
    _initializeChildren() {
      if (!this._config.parent) return;
      const t = J.find(`.${Qt} .${Qt}`, this._config.parent);
      J.find(ne, this._config.parent)
    ...
    static jQueryInterface(t) {
      return this.each(function () {
        ...
        const i = se.getOrCreateInstance(this, e);
        if ("string" == typeof t) {
  ...
  j.on(document, Xt, ne, function (t) {
    ("A" === t.target.tagName ||
  ...
  var oe = "top",
    ...
    ge = "popper",
    me = "reference",
    _e = he.reduce(function (t, e) {
      return t.concat([e + "-" + de, e + "-" + ue]);
    }, []),
    be = [].concat(he, [ce]).reduce(function (t, e) {
      return t.concat([e, e + "-" + de, e + "-" + ue]);
    }, []),
    ve = [
      "beforeRead",
      "read",
  ...
  function Te(t) {
    return (
      ...
      (t instanceof we(t).ShadowRoot || t instanceof ShadowRoot)
    );
  }
  var Oe = {
    name: "applyStyles",
  ...
  function Le(t, e) {
    ...
    return (
      ...
      {
        width: ke(i.width / n),
        height: ke(i.height / s),
        top: ke(i.top / s),
        right: ke(i.right / n),
        bottom: ke(i.bottom / s),
        left: ke(i.left / n),
        x: ke(i.left / n),
        y: ke(i.top / s),
      }
  ...
  function Ie(t) {
    return (
      (Ee(t) ? t.ownerDocument : t.document) || window.document
    ).documentElement;
  }
  function Pe(t) {
    return "html" === ye(t)
      ? t
      : t.assignedSlot || t.parentNode || (Te(t) ? t.host : null) || Ie(t);
  }
  function je(t) {
    return Ae(t) && "fixed" !== Se(t).position ? t.offsetParent : null;
  }
  function Me(t) {
    for (var e = we(t), i = je(t); i && Ne(i) && "static" === Se(i).position; )
      i = je(i);
    return i &&
      ("html" === ye(i) || ("body" === ye(i) && "static" === Se(i).position))
      ? e
      : i ||
          (function (t) {
  ...
  var Fe = {
      ...
      fn: function (t) {
        var e,
          ...
          a = Ce(i.placement),
          l = $e(a),
          c = [le, ae].indexOf(a) >= 0 ? "height" : "width";
        if (o && r) {
          var h = (function (t, e) {
              return ze(
                "number" !=
    ...
    Ue = { top: "auto", right: "auto", bottom: "auto", left: "auto" };
  function Ve(t) {
    var e,
      i = t.popper,
      n = t.popperRect,
    ...
    if (l) {
      var y = Me(i),
        ...
        E = "clientWidth";
      y === we(i) &&
        "static" !== Se((y = Ie(i))).position &&
        ((w = "scrollHeight"), (E = "scrollWidth")),
        (y = y),
        s === oe && ((b = re), (p -= y[w] - n.height), (p *= a ? 1 : -1)),
        s === le && ((_ = ae), (u -= y[E] - n.width), (u *= a ? 1 : -1));
    }
    var A,
      T = Object.assign({ position: r }, l && Ue);
    return a
      ? Object.assign(
          {},
          T,
  ...
  function ei(t) {
    return Le(Ie(t)).left + ti(t).scrollLeft;
  }
  function ii(t) {
    var e = Se(t),
      i = e.overflow,
  ...
  function ni(t, e) {
    ...
    var n = (function t(e) {
      ...
      o = we(n),
      r = s ? [o].concat(o.visualViewport || [], ii(n) ? n : []) : n,
      a = e.concat(r);
    return s ? a : a.concat(ni(Pe(r)));
  }
  function si(t) {
  ...
  function li(t, e) {
    ...
    var i = e,
      ...
      f = i.padding,
      p = void 0 === f ? 0 : f,
      g = ze("number" != typeof p ? p : qe(p, he)),
      m = h === ge ? me : ge,
      ...
      })(Ee(v) ? v : v.contextElement || Ie(t.elements.popper), r, l),
      w = Le(_),
      E = ai({ reference: w, element: b, strategy: "absolute", placement: s }),
      A = si(Object.assign({}, b, E)),
      T = h === ge ? A : w,
      O = {
    ...
    if (h === ge && C) {
      ...
      Object.keys(O).forEach(function (t) {
        var e = [ae, re].indexOf(t) >= 0 ? 1 : -1,
          i = [oe, re].indexOf(t) >= 0 ? "y" : "x";
        O[t] += k[i] * e;
      });
    }
    return O;
  ...
  function di(t) {
    return [oe, ae, re, le].some(function (e) {
      return t[e] >= 0;
    });
  }
  var ui = {
      ...
      fn: function (t) {
        var e = t.state,
          ...
          r = li(e, { elementContext: "reference" }),
          a = li(e, { altBoundary: !0 }),
          l = hi(r, n),
          c = hi(a, s, o),
          h = di(l),
          d = di(c);
            ...
            return (
              (t[i] = (function (t, e, i) {
                ...
                return (
                  (r = r || 0),
                  (a = (a || 0) * s),
                  [le, ae].indexOf(n) >= 0 ? { x: a, y: r } : { x: r, y: a }
                );
              })(i, e.rects, o)),
              t
            );
        ...
        (("body" !== ye(e) || ii(a)) &&
          (c =
            (n = e) !== we(n) && Ae(n)
              ...
              : ti(n)),
        Ae(e)
          ? (((h = Le(e, !0)).x += e.clientLeft), (h.y += e.clientTop))
          : a && (h.x = ei(a))),
      {
        ...
        h = {
          ...
          forceUpdate: function () {
            if (!c) {
              ...
              if (bi(e, i)) {
                (a.rects = {
                  reference: mi(e, Me(i), "fixed" === a.options.strategy),
                  popper: xe(i),
                }),
                  (a.reset = !1),
  ...
  var yi = vi(),
    wi = vi({ defaultModifiers: [Ye, pi, Ke, Oe] }),
    Ei = vi({ defaultModifiers: [Ye, pi, Ke, Oe, fi, ci, gi, Fe, ui] }),
    Ai = Object.freeze({
      __proto__: null,
      popperGenerator: vi,
      detectOverflow: li,
  ...
  const Ti = "dropdown",
    ...
    xi = "ArrowDown",
    Di = 2,
    Si = new RegExp(`${Li}|${xi}|${Oi}`),
    Ni = "hide.bs.dropdown",
    Ii = "hidden.bs.dropdown",
    Pi = "show.bs.dropdown",
    ji = "shown.bs.dropdown",
    Mi = "show",
    $i = "dropup",
    Hi = "dropend",
    Bi = "dropstart",
    Ri = "navbar",
    Wi = '[data-bs-toggle="dropdown"]',
    zi = ".dropdown-menu",
    qi = ".navbar-nav",
    Fi = ".dropdown-menu .dropdown-item:not(.disabled):not(:disabled)",
    Ui = g() ? "top-end" : "top-start",
    Vi = g() ? "top-start" : "top-end",
    Ki = g() ? "bottom-end" : "bottom-start",
    Xi = g() ? "bottom-start" : "bottom-end",
    Yi = g() ? "left-start" : "right-start",
    Qi = g() ? "right-start" : "left-start",
    Gi = {
      offset: [0, 2],
  ...
  class Ji extends B {
    ...
    show() {
      ...
      if (j.trigger(this._element, Pi, t).defaultPrevented) return;
      const e = Ji.getParentFromElement(this._element);
      this._inNavbar
    ...
    _completeHide(t) {
      j.trigger(this._element, Ni, t).defaultPrevented ||
        ("ontouchstart" in document.documentElement &&
          []
            .concat(...document.body.children)
    ...
    _getConfig(t) {
      if (
        ...
        a(Ti, t, this.constructor.DefaultType),
    ...
    _createPopper(t) {
      ...
      (this._popper = Ei(e, this._menu, i)),
    ...
    _getMenuElement() {
      return J.next(this._element, zi)[0];
    }
    _getPlacement() {
      const t = this._element.parentNode;
      if (t.classList.contains(Hi)) return Yi;
      if (t.classList.contains(Bi)) return Qi;
      const e =
        "end" ===
        getComputedStyle(this._menu).getPropertyValue("--bs-position").trim();
      return t.classList.contains($i) ? (e ? Vi : Ui) : e ? Xi : Ki;
    }
    _detectNavbar() {
      return null !== this._element.closest(`.${Ri}`);
    }
    _getOffset() {
    ...
    _selectMenuItem({ key: t, target: e }) {
      const i = J.find(Fi, this._menu).filter(l);
    ...
    static clearMenus(t) {
      if (t && (t.button === Di || ("keyup" === t.type && t.key !== ki)))
        return;
      const e = J.find(Wi);
      for (let i = 0, n = e.length; i < n; i++) {
        const n = Ji.getInstance(e[i]);
    ...
    static dataApiKeydownHandler(t) {
      if (
        /input|textarea/i.test(t.target.tagName)
          ? t.key === Ci ||
            (t.key !== Oi &&
              ((t.key !== xi && t.key !== Li) || t.target.closest(zi)))
          : !Si.test(t.key)
      )
        return;
      const e = this.classList.contains(Mi);
      if (!e && t.key === Oi) return;
      if ((t.preventDefault(), t.stopPropagation(), c(this))) return;
      const i = this.matches(Wi) ? this : J.prev(this, Wi)[0],
        n = Ji.getOrCreateInstance(i);
      if (t.key !== Oi)
        return t.key === Li || t.key === xi
          ? (e || n.show(), void n._selectMenuItem(t))
          : void ((e && t.key !== Ci) || Ji.clearMenus());
      n.hide();
    }
  }
  j.on(document, "keydown.bs.dropdown.data-api", Wi, Ji.dataApiKeydownHandler),
    j.on(
      document,
      "keydown.bs.dropdown.data-api",
      zi,
      Ji.dataApiKeydownHandler
    ),
    j.on(document, "click.bs.dropdown.data-api", Ji.clearMenus),
    j.on(document, "keyup.bs.dropdown.data-api", Ji.clearMenus),
    j.on(document, "click.bs.dropdown.data-api", Wi, function (t) {
      t.preventDefault(), Ji.getOrCreateInstance(this).toggle();
    }),
    m(Ji);
  const tn = ".fixed-top, .fixed-bottom, .is-fixed, .sticky-top",
    en = ".sticky-top";
  class nn {
    constructor() {
    ...
    hide() {
      ...
      this._disableOverFlow(),
        ...
        this._setElementAttributes(tn, "paddingRight", (e) => e + t),
        this._setElementAttributes(en, "marginRight", (e) => e - t);
    }
    _disableOverFlow() {
    ...
    reset() {
      this._resetElementAttributes(this._element, "overflow"),
        ...
        this._resetElementAttributes(tn, "paddingRight"),
        this._resetElementAttributes(en, "marginRight");
    }
  ...
  class hn {
    ...
    show(t) {
      this._config.isVisible
        ? (this._append(),
          ...
          this._getElement().classList.add(ln),
    ...
    _getElement() {
      if (!this._element) {
        ...
        (t.className = this._config.className),
          this._config.isAnimated && t.classList.add(an),
          (this._element = t);
      }
    ...
    _getConfig(t) {
      return (
        ((t = { ...sn, ...("object" == typeof t ? t : {}) }).rootElement = r(
          t.rootElement
        )),
        a(rn, t, on),
        t
  ...
  const dn = { trapElement: null, autofocus: !0 },
  ...
  class yn {
    ...
    activate() {
      ...
      this._isActive ||
        (e && t.focus(),
        j.off(document, pn),
        j.on(document, gn, (t) => this._handleFocusin(t)),
        j.on(document, mn, (t) => this._handleKeydown(t)),
        (this._isActive = !0));
    }
    deactivate() {
      this._isActive && ((this._isActive = !1), j.off(document, pn));
    }
    _handleFocusin(t) {
      const { target: e } = t,
    ...
    _handleKeydown(t) {
      t.key === _n && (this._lastTabNavDirection = t.shiftKey ? vn : bn);
    }
    _getConfig(t) {
      return (
        (t = { ...dn, ...("object" == typeof t ? t : {}) }), a(fn, t, un), t
      );
    }
  }
  const wn = "modal",
    ...
    Sn = `resize${En}`,
    Nn = `click.dismiss${En}`,
    In = `keydown.dismiss${En}`,
    Pn = `mouseup.dismiss${En}`,
    jn = `mousedown.dismiss${En}`,
    Mn = `click${En}.data-api`,
    $n = "modal-open",
    Hn = "fade",
    Bn = "show",
    Rn = "modal-static",
  ...
  class qn extends B {
    constructor(t, e) {
      super(t),
        (this._config = this._getConfig(e)),
        (this._dialog = J.findOne(Wn, this._element)),
        (this._backdrop = this._initializeBackDrop()),
        (this._focustrap = this._initializeFocusTrap()),
        (this._isShown = !1),
        (this._ignoreBackdropClick = !1),
        (this._isTransitioning = !1),
        (this._scrollBar = new nn());
    }
    static get Default() {
      return Tn;
    }
    ...
    show(t) {
      this._isShown ||
        ...
        j.trigger(this._element, xn, { relatedTarget: t }).defaultPrevented ||
        ((this._isShown = !0),
        ...
        j.on(this._dialog, jn, () => {
          j.one(this._element, Pn, (t) => {
    ...
    hide() {
      ...
      if (j.trigger(this._element, Cn).defaultPrevented) return;
      this._isShown = !1;
      ...
      t && (this._isTransitioning = !0),
        ...
        j.off(this._element, Nn),
        j.off(this._dialog, jn),
        this._queueCallback(() => this._hideModal(), this._element, t);
    }
    dispose() {
      [window, this._dialog].forEach((t) => j.off(t, En)),
        ...
        this._queueCallback(
          () => {
            this._config.focus && this._focustrap.activate(),
              (this._isTransitioning = !1),
              j.trigger(this._element, Dn, { relatedTarget: t });
          },
          this._dialog,
          e
        );
    ...
    _setEscapeEvent() {
      this._isShown
        ? j.on(this._element, In, (t) => {
            this._config.keyboard && t.key === An
              ? (t.preventDefault(), this.hide())
              : this._config.keyboard ||
                t.key !== An ||
                this._triggerBackdropTransition();
          })
        : j.off(this._element, In);
    }
    _setResizeEvent() {
      this._isShown
      ...
      (this._element.style.display = "none"),
        ...
        this._backdrop.hide(() => {
          document.body.classList.remove($n),
            ...
            j.trigger(this._element, Ln);
        });
    }
    _showBackdrop(t) {
      j.on(this._element, Nn, (t) => {
    ...
    static jQueryInterface(t, e) {
      return this.each(function () {
        const i = qn.getOrCreateInstance(this, t);
        if ("string" == typeof t) {
          if (void 0 === i[t]) throw new TypeError(`No method named "${t}"`);
          i[t](e);
        }
  ...
  j.on(document, Mn, '[data-bs-toggle="modal"]', function (t) {
    const e = n(this);
  ...
  const Fn = "offcanvas",
    ...
    Qn = "show.bs.offcanvas",
    Gn = "shown.bs.offcanvas",
    Zn = "hide.bs.offcanvas",
    Jn = "hidden.bs.offcanvas",
    ts = "keydown.dismiss.bs.offcanvas";
  class es extends B {
    constructor(t, e) {
      super(t),
        (this._config = this._getConfig(e)),
    ...
    show(t) {
      this._isShown ||
        j.trigger(this._element, Qn, { relatedTarget: t }).defaultPrevented ||
        ((this._isShown = !0),
        ...
        this._queueCallback(
          () => {
            this._config.scroll || this._focustrap.activate(),
              j.trigger(this._element, Gn, { relatedTarget: t });
          },
          this._element,
          !0
        ));
    ...
    hide() {
      this._isShown &&
        (j.trigger(this._element, Zn).defaultPrevented ||
          (this._focustrap.deactivate(),
          this._element.blur(),
          (this._isShown = !1),
          ...
          this._queueCallback(
            () => {
              this._element.setAttribute("aria-hidden", !0),
                ...
                this._config.scroll || new nn().reset(),
    ...
    _addEventListeners() {
      j.on(this._element, ts, (t) => {
        this._config.keyboard && t.key === Un && this.hide();
      });
    }
    static jQueryInterface(t) {
      return this.each(function () {
  ...
  j.on(
    ...
    function (t) {
      ...
      i && i !== e && es.getInstance(i).hide(),
        es.getOrCreateInstance(e).toggle(this);
    }
  ),
    j.on(window, "load.bs.offcanvas.data-api", () =>
      J.find(".offcanvas.show").forEach((t) => es.getOrCreateInstance(t).show())
    ),
    R(es),
    m(es);
  const is = new Set([
    ...
    ns = /^(?:(?:https?|mailto|ftp|tel|file):|[^#&/:?]*(?:[#/?]|$))/i,
    ss =
    ...
    os = (t, e) => {
      ...
      if (e.includes(i))
        return (
          !is.has(i) || Boolean(ns.test(t.nodeValue) || ss.test(t.nodeValue))
        );
  ...
  function rs(t, e, i) {
    ...
    for (let t = 0, i = o.length; t < i; t++) {
      ...
      const r = [].concat(...i.attributes),
        a = [].concat(e["*"] || [], e[n] || []);
      r.forEach((t) => {
        os(t, a) || i.removeAttribute(t.nodeName);
      });
    }
  ...
  class Os extends B {
    ...
    toggle(t) {
      if (this._isEnabled)
        if (t) {
          ...
          if (this.getTipElement().classList.contains(gs))
    ...
    dispose() {
      clearTimeout(this._timeout),
        j.off(this._element.closest(vs), ys, this._hideModalHandler),
    ...
    show() {
      ...
      s.setAttribute("id", o),
        ...
        this._config.animation && s.classList.add(ps);
      const r =
      ...
      $.set(s, this.constructor.DATA_KEY, this),
        ...
        this._popper
          ? this._popper.update()
          : (this._popper = Ei(this._element, s, this._getPopperConfig(a))),
        s.classList.add(gs);
      ...
      const u = this.tip.classList.contains(ps);
      this._queueCallback(
        () => {
          const t = this._hoverState;
          (this._hoverState = null),
            j.trigger(this._element, this.constructor.Event.SHOWN),
            t === _s && this._leave(null, this);
        },
        this.tip,
        u
      );
    ...
    hide() {
      ...
      const e = this.tip.classList.contains(ps);
      this._queueCallback(
        () => {
          this._isWithActiveTrigger() ||
            (this._hoverState !== ms && t.remove(),
            this._cleanTipClass(),
    ...
    getTipElement() {
      ...
      return (
        this.setContent(e), e.classList.remove(ps, gs), (this.tip = e), this.tip
      );
    }
    setContent(t) {
      this._sanitizeAndSetContent(t, this.getTitle(), bs);
    }
        ...
        return o(e)
          ...
          : void (this._config.html
              ? (this._config.sanitize &&
                  (e = rs(e, this._config.allowList, this._config.sanitizeFn)),
                (t.innerHTML = e))
              : (t.textContent = e));
    }
    getTitle() {
    ...
    _setListeners() {
      this._config.trigger.split(" ").forEach((t) => {
        ...
        j.on(this._element.closest(vs), ys, this._hideModalHandler),
        this._config.selector
          ? (this._config = {
              ...this._config,
              trigger: "manual",
    ...
    _enter(t, e) {
      (e = this._initializeOnDelegatedTarget(t, e)),
        t && (e._activeTrigger["focusin" === t.type ? Es : ws] = !0),
        e.getTipElement().classList.contains(gs) || e._hoverState === ms
          ? (e._hoverState = ms)
          : (clearTimeout(e._timeout),
            (e._hoverState = ms),
            e._config.delay && e._config.delay.show
              ? (e._timeout = setTimeout(() => {
                  e._hoverState === ms && e.show();
    ...
    _leave(t, e) {
      (e = this._initializeOnDelegatedTarget(t, e)),
        t &&
          (e._activeTrigger["focusout" === t.type ? Es : ws] =
    ...
    _getConfig(t) {
      ...
      return (
        ...
        a(as, t, this.constructor.DefaultType),
        t.sanitize && (t.template = rs(t.template, t.allowList, t.sanitizeFn)),
        t
      );
    }
    _getDelegateConfig() {
  ...
  const Cs = "popover",
    ...
    xs = { ...Os.DefaultType, content: "(string|element|function)" },
    Ds = {
  ...
  class Is extends Os {
    ...
    setContent(t) {
      this._sanitizeAndSetContent(t, this.getTitle(), Ss),
        this._sanitizeAndSetContent(t, this._getContent(), Ns);
    }
    _getContent() {
  ...
  class Zs extends B {
    constructor(t, e) {
      super(t),
        ...
        j.on(this._scrollElement, Bs, () => this._process()),
        this.refresh(),
        this._process();
    }
    static get Default() {
    ...
    refresh() {
      const t = this._scrollElement === this._scrollElement.window ? Qs : Gs,
        e = "auto" === this._config.method ? t : this._config.method,
        n = e === Gs ? this._getScrollTop() : 0;
      (this._offsets = []),
        (this._targets = []),
        (this._scrollHeight = this._getScrollHeight()),
        J.find(Ks, this._config.target)
          .map((t) => {
            const s = i(t),
    ...
    dispose() {
      j.off(this._scrollElement, js), super.dispose();
    }
    _getConfig(t) {
      return (
        ((t = {
    ...
    _activate(t) {
      ...
      const e = Ks.split(",").map(
          (e) => `${e}[data-bs-target="${t}"],${e}[href="${t}"]`
        ),
        i = J.findOne(e.join(","), this._config.target);
      i.classList.add(zs),
        i.classList.contains(Ws)
          ? J.findOne(Ys, i.closest(Xs)).classList.add(zs)
          : J.parents(i, qs).forEach((t) => {
              J.prev(t, `${Fs}, ${Vs}`).forEach((t) => t.classList.add(zs)),
                J.prev(t, Us).forEach((t) => {
                  J.children(t, Fs).forEach((t) => t.classList.add(zs));
                });
            }),
        j.trigger(this._scrollElement, Hs, { relatedTarget: t });
    }
    _clear() {
      J.find(Ks, this._config.target)
        .filter((t) => t.classList.contains(zs))
        .forEach((t) => t.classList.remove(zs));
    }
    static jQueryInterface(t) {
      return this.each(function () {
  ...
  j.on(window, Rs, () => {
    J.find('[data-bs-spy="scroll"]').forEach((t) => new Zs(t));
  }),
    m(Zs);
  const Js = "tab",
    to = "hide.bs.tab",
  ...
  class go extends B {
    ...
    show() {
      ...
      const e = n(this._element),
        i = this._element.closest(co);
      if (i) {
        const e = "UL" === i.nodeName || "OL" === i.nodeName ? uo : ho;
        t = (t = J.find(e, i))[t.length - 1];
      }
      const s = t ? j.trigger(t, to, { relatedTarget: this._element }) : null;
      if (
        j.trigger(this._element, io, { relatedTarget: t }).defaultPrevented ||
        (null !== s && s.defaultPrevented)
      )
        return;
      this._activate(this._element, i);
      const o = () => {
        j.trigger(t, eo, { relatedTarget: this._element }),
          j.trigger(this._element, no, { relatedTarget: t });
      };
    ...
    _activate(t, e, i) {
      const n = (
        ...
        s = i && n && n.classList.contains(ro),
        o = () => this._transitionComplete(t, n, i);
      n && s ? (n.classList.remove(ao), this._queueCallback(o, t, !0)) : o();
    }
    _transitionComplete(t, e, i) {
      if (e) {
        e.classList.remove(oo);
        const t = J.findOne(po, e.parentNode);
        t && t.classList.remove(oo),
      ...
      t.classList.add(oo),
        ...
        u(t),
        t.classList.contains(ro) && t.classList.add(ao);
      let n = t.parentNode;
      if (
        (n && "LI" === n.nodeName && (n = n.parentNode),
        n && n.classList.contains(so))
      ) {
        const e = t.closest(lo);
        e && J.find(fo, e).forEach((t) => t.classList.add(oo)),
    ...
    static jQueryInterface(t) {
      return this.each(function () {
        const e = go.getOrCreateInstance(this);
        if ("string" == typeof t) {
          if (void 0 === e[t]) throw new TypeError(`No method named "${t}"`);
          e[t]();
        }
  ...
  j.on(
    ...
    function (t) {
      ["A", "AREA"].includes(this.tagName) && t.preventDefault(),
        c(this) || go.getOrCreateInstance(this).show();
    }
  ),
    m(go);
  const mo = "toast",
    ...
    Do = { animation: !0, autohide: !0, delay: 5e3 };
  class So extends B {
    constructor(t, e) {
      super(t),
        (this._config = this._getConfig(e)),
    ...
    show() {
      j.trigger(this._element, Ao).defaultPrevented ||
        (this._clearTimeout(),
        this._config.animation && this._element.classList.add(Oo),
    ...
    hide() {
      this._element.classList.contains(ko) &&
        (j.trigger(this._element, wo).defaultPrevented ||
          (this._element.classList.add(Lo),
          this._queueCallback(
            () => {
    ...
    _setListeners() {
      j.on(this._element, _o, (t) => this._onInteraction(t, !0)),
        j.on(this._element, bo, (t) => this._onInteraction(t, !1)),
        j.on(this._element, vo, (t) => this._onInteraction(t, !0)),
        j.on(this._element, yo, (t) => this._onInteraction(t, !1));
    }
    _clearTimeout() {
  ...
  var t = (function (e, t, a) {
    ...
    if (
      ((function () {
        ...
        for (t in ((i = e.lazySizesConfig || e.lazysizesConfig || {}), a))
          t in i || (i[t] = a[t]);
      })(),
    ...
    var r = t.documentElement,
      ...
      x = (function () {
        var o,
          ...
          $ = -1,
          q = function (e) {
            P--, (!e || P < 0 || !e.target) && (P = 0);
          },
          U = function (e) {
            return (
              null == I && (I = "hidden" == E(t.body, "visibility")),
              I ||
                !(
          ...
          G = function () {
            var e,
              ...
              p,
              C = n.elements;
            if ((z = i.loadMode) && P < 8 && (e = C.length)) {
              for (a = 0, $++; a < e; a++)
                if (C[a] && !C[a]._lazyRace)
                  if (!H || (n.prematureUnveil && n.prematureUnveil(C[a])))
                    Z(C[a]);
                  else if (
                    (((y = C[a][l]("data-expand")) && (u = 1 * y)) || (u = O),
                    v ||
                      ((v =
                        !i.expand || i.expand < 1
                    ...
                    (R = s.bottom) >= m &&
                      ...
                      (R || F || B || T) &&
                      (i.loadHidden || U(C[a])) &&
                      ((f && P < 3 && !y && (z < 3 || $ < 4)) || j(C[a], u)))
                  ) {
                    if ((Z(C[a]), (d = !0), P > 9)) break;
                  } else
                    !d &&
                      f &&
                      !c &&
          ...
          Y = w(function (e, t, a, n, r) {
            var o, s, c, u, f, z;
            (f = b(e, "lazybeforeunveil", t)).defaultPrevented ||
              (n && (a ? h(e, i.autosizesClass) : e.setAttribute("sizes", n)),
              (s = e[l](i.srcsetAttr)),
              (o = e[l](i.srcAttr)),
              r && (u = (c = e.parentNode) && m.test(c.nodeName || "")),
              (z = t.firesLoad || ("src" in e && (s || o || u))),
              (f = { target: e }),
              h(e, i.loadingClass),
              z && (clearTimeout(y), (y = d(q, 2500)), C(e, V, !0)),
              u && g.call(c.getElementsByTagName("source"), X),
              s
                ...
                : o &&
                  ...
                  (D.test(e.nodeName)
                    ? (function (e, t) {
                        var a =
                          e.getAttribute("data-load-mode") || i.iframeLoadMode;
                        0 == a
          ...
          _: function () {
            (_ = a.now()),
              ...
              /d$|^c/.test(t.readyState)
                ? ae()
                : (c("load", ae), t[s]("DOMContentLoaded", J), d(ae, 2e4)),
              n.elements.length ? (G(), M._lsFlush()) : J();
          },
          checkElems: J,
          unveil: Z,
          _aLSL: te,
      ...
      W = function () {
        !W.i && t.getElementsByClassName && ((W.i = !0), S._(), x._());
      };
    return (
      d(function () {
        i.init && W();
...
"loading" in HTMLImageElement.prototype &&
  (document.addEventListener("lazybeforeunveil", function (e) {
    let t = e.target.getAttribute("data-bg");
    t && (e.target.style.backgroundImage = "url(" + t + ")");
  }),
  lazyImages.forEach((e) => {
    e.classList.remove("lazyload"),
      e.dataset.src && e.removeAttribute("data-src"),
      e.dataset.srcset && e.removeAttribute("data-srcset");
  }));
var KeyValueStore = {
    get: function (e) {
      throw "KeyValueStore.get() Not Implemented";
    },
    getBool: function (e, t) {
      var o = this.get(e);
      return "boolean" == typeof o ? o : "boolean" == typeof t && t;
    },
    ...
    getJsonArray: function (e) {
      var t = this.get(e);
      return void 0 !== t ? JSON.parse(t) : [];
    },
    set: function (e, t) {
      throw "KeyValueStore.set() Not Implemented";
    },
    setBool: function (e, t) {
      this.set(e, !!t);
    },
    setIsRealMode: function (e) {
      this.setBool(this.keys.IsRealMode, e);
    },
    ...
    setJsonArray: function (e, t) {
      var o = JSON.stringify(t);
      this.set(e, o);
    },
    remove: function (e) {
      throw "KeyValueStore.remove() Not Implemented";
    },
  },
  CookieWrapper = (function () {
    "use strict";
    return {
      write: function (e, t, o) {
        $.cookie(e, t, $.extend({ path: "/", expires: 365 }, o || {}));
      },
      read: function (e) {
        return $.cookie(e);
      },
...
!(function () {
  ...
  var e = (function () {
    ...
    : (function () {
        function e(e) {
          (e = JSON.stringify(e)), CookieWrapper.write("localStorage", e);
        }
        var t,
          o = (t = CookieWrapper.read("localStorage")) ? JSON.parse(t) : {};
        return {
          getItem: function (e) {
  ...
  $.extend(KeyValueStore, {
    get: function (t) {
      var o = e.getItem(t);
      return null !== o && "null" !== o
        ? o
        : (o = CookieWrapper.read(t))
        ? (CookieWrapper.remove(t), this.set(t, o), o)
        : null;
    },
    getBool: function (e, t) {
      var o = this.get(e);
    ...
    remove: function (t) {
      e.removeItem(t), $.removeCookie(t, { path: "/" });
    },
  });
})(),
  (function (e) {
    ...
    function n(e) {
      return o(i.json ? JSON.stringify(e) : String(e));
    }
    function r(o, n) {
      var r = i.raw
        ? o
    ...
    var i = (e.cookie = function (t, u, a) {
      ...
      for (
        ...
        var g = l[m].split("="),
          v = ((f = g.shift()), i.raw ? f : decodeURIComponent(f)),
          h = g.join("=");
        if (t && t === v) {
          p = r(h, u);
          break;
        }
        t || void 0 === (h = r(h)) || (p[v] = h);
      }
      return p;
    });
    (i.defaults = {}),
      (e.removeCookie = function (t, o) {
        return (
          void 0 !== e.cookie(t) &&
          (e.cookie(t, "", e.extend({}, o, { expires: -1 })), !e.cookie(t))
        );
      });
  });
var UserCookiesManager = (function (e) {
  return {
    persistSelection: function (o, i, t) {
      var n = [];
      o && n.push(e.essentialCookieName),
        i && n.push(e.performanceCookieName),
        t && n.push(e.targetingCookieName),
        CookieWrapper.write(e.cookieKeyName, n.join());
    },
    isAcceptedCookies: function () {
      return !0 === KeyValueStore.getBool("_cookies_usage_", !1);
    },
    isAcceptedPerformance: function () {
      var o = CookieWrapper.read(e.cookieKeyName);
      return void 0 !== o && o.indexOf(e.performanceCookieName) > -1;
    },
    isAcceptedTargeting: function () {
      var o = CookieWrapper.read(e.cookieKeyName);
      return void 0 !== o && o.indexOf(e.targetingCookieName) > -1;
    },
    persistCookiesAcceptance: function () {
      KeyValueStore.setBool("_cookies_usage_", !0);
    },
    onCookiesAccept: function (o) {
      this.persistSelection(!0, !0, !0),
        this.persistCookiesAcceptance(),
        this.fireTracking(),
        sendAnalyticsEvent("UserCookies", "accept", o),
        sendAnalyticsEvent(
          "UserCookies",
          "select-automatically",
          e.targetingCookieName
        ),
        sendAnalyticsEvent(
          "UserCookies",
          "select-automatically",
          e.performanceCookieName
        );
    },
    onCookiesModalAccept: function (o, i) {
      KeyValueStore.setBool("Disable3rdPartyAnalytics", !i),
        disableGoogleAnalytics(!i);
      var t = this.isAcceptedCookies() && this.isAcceptedPerformance();
      this.persistSelection(!0, i, o),
        this.persistCookiesAcceptance(),
        o &&
          (this.fireTracking(),
          sendAnalyticsEvent(
  ...
  essentialCookieName: "essential",
  targetingCookieName: "targeting",
  performanceCookieName: "performance",
  cookieKeyName: "cak",
});
function sendAnalyticsEvent(e, t, n, i) {
  try {
    if (
      "undefined" != typeof UserCookiesManager &&
      UserCookiesManager.isAcceptedCookies() &&
      !UserCookiesManager.isAcceptedPerformance()
    )
      return;
    if ("undefined" == typeof dataLayer)
      return void log(
        "general.googleAnalytics.sendEvent dataLayer is undefined"
      );
    null != e &&
      null != t &&
      ((n = null == n ? "" : n.toString()),
...
document.addEventListener("click", function (e) {
  let t = e.target;
  for (; t && "BUTTON" !== t.tagName && "A" !== t.tagName; )
    t = t.parentElement;
  if (!t) return;
  const n = t.getAttribute("data-analytics"),
    i = -1,
    a = (function (e) {
      const t = document.querySelectorAll("section");
      for (let n = 0; n < t.length; n++) if (t[n].contains(e)) return n + 1;
      return i;
    })(t),
    r = {
      clickUrl: t.getAttribute("href"),
      clickText: t.innerText,
      sectionId: a,
    };
  if (n && n.indexOf("CTA") !== i) {
    let e;
    "undefined" != typeof reportCtaClickUrl &&
      fetch(reportCtaClickUrl, { method: "POST" });
    const i = ["real", "demo", "store"];
    for (const t of i)
      if (n.indexOf(t) > -1) {
        e = t;
        break;
      }
    const a = t.getAttribute("type-of-widget"),
      o = { event: "CTA", mode: e, ...r };
    a
      ? window.dataLayer.push({ ...o, typeOfWidget: a })
      : window.dataLayer.push({ ...o });
  } else if (n && n.indexOf("buttonClick") !== i)
    window.dataLayer.push({ event: "buttonClick", ...r });
  else if (n && n.indexOf("videoGridClick") !== i)
    window.dataLayer.push({ event: "videoGridClick", ...r });
  else if (n && n.indexOf("widgetInteractions") !== i) {
    const e = n.indexOf("tab") !== i ? "tab" : "instrumentName",
      a = t.getAttribute("type-of-widget");
    window.dataLayer.push({
      event: "widgetInteractions",
      ...r,
      clickType: e,
      typeOfWidget: a,
      InstrumentCategory: t.getAttribute("category"),
      InstrumentSymbol: t.getAttribute("instrumentName"),
    });
  } else if (n && n.indexOf("menuClick") !== i) {
    const { clickUrl: e, clickText: n } = r;
    let i = t.closest("[data-menu-name]");
    window.dataLayer.push({
      event: "menuClick",
      clickText: n,
      clickUrl: e,
      tabName: i ? i.getAttribute("data-menu-name") : null,
    });
  } else
    n &&
      n.indexOf("cookies") !== i &&
      window.dataLayer.push({
        event: "cookies",
        dialogType: t.getAttribute("dialogType"),
        clickType: t.getAttribute("clickType"),
      });
});
